class NzmuseumsRotoruaOai < DnzHarvester::Oai::Base
  ...
  attribute :thumbnail_url,    			from: "dc:identifier[@linktype='thumbnail']"
  ...
  attributes :landing_url, :identifier,	from: "dc:identifier[@linktype='fulltext']" do
    find_and_replace(/http:\/\/ehive.com/, 'http://www.nzmuseums.co.nz').within(:identifier)
  end
