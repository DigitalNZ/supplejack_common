...
module SupplejackCommon
  ...
  class Resource
    ...
    attr_reader :url, :throttling_options, :attributes, :request_timeout, :http_headers, :proxy
    ...
    def fetch_document
      SupplejackCommon::Request.get(url, request_timeout, throttling_options, http_headers, proxy)
    end
  end
end
