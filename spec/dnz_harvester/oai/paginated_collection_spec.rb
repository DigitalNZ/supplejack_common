...
describe DnzHarvester::Oai::PaginatedCollection do

  class TestSource < DnzHarvester::Oai::Base; end
  ...
  it "initializes the client, options and klass" do
    collection = DnzHarvester::Oai::PaginatedCollection.new(client, options, klass)
  ...
  it "initializes the limit" do
    DnzHarvester::Oai::PaginatedCollection.new(client, {limit: 10}, klass).limit.should eq 10
  end

  describe "#each" do
    let(:collection) { DnzHarvester::Oai::PaginatedCollection.new(client, {}, TestSource) }
